...
1. If you were to describe semantic HTML to the next cohort of students, what would you say? Semantic HTML means that you are giving a structure to a webpage. It gives it more meaning than a bunch of words.

2. What are the 4 areas of the box model? Margin, Padding, Border, Content

3. While using flexbox, what axis does the following property work on: ```align-items: center```? The cross axis to the main axis.

4. Explain why git is valuable to a team of developers. It enables several people to work on the same project at the same time withough interfering with eachothers code. It also allows them to go back to any save points

5. Define mobile-first design in your own words. It's where you first design a webpage based off of a mobile screen size, and then work up from that. Typically making the mobile site load faster. 
